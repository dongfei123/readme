  ...
  <body>
    ...
    <div class="x-body">
      <div class="layui-row">
        ...
        method="post" class="layui-form layui-col-md12 x-so layui-form-pane">
          <div class="layui-input-inline">
            <select name="cateid">
              <option value="">规则分类</option>
              @foreach($permission_cates as $permission_cate)
              <option value="{{$permission_cate->id}}">{{$permission_cate->cate_name}}</option>
              @endforeach
            </select>
          </div>
          <div class="layui-input-inline">
          ...
          <div class="layui-input-inline">
            <select name="action">
              ...
              <option value="tabStatus">tabStatus</option>
